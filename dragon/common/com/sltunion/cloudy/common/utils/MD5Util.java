...
public class MD5Util {
	...
	public static void main(String[] args) {
		String password = MD5Util.md5("quanguoa");
		System.out.println("对admin用MD5摘要后的字符串：" + password);
		String inputString = "tianshi0253";
		System.out.println("tianshi0253与密码匹配?"
				+ MD5Util.compare(password, inputString));
		inputString = "quanguoa";
		System.out.println("admin与密码匹配?" + MD5Util.compare(password, inputString));
	}
}

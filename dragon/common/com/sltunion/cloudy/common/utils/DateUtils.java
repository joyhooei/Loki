...
public final class DateUtils {
	...
	/**
	 * 获取当前日期时间字符串相差deff分钟的时间,格式为 yyyy-MM-dd hh:mm:ss
	 * 
	 * @return 返回当前字符串
	 */
	public static String getDatetime(String starttime,int deff) {
		Calendar c = getCurCalendar();
		Date date = paseDatetime(starttime);
		c.setTime(date);
	 ...
	 * @return 返回当前时间
	 */
	public static String getTim(Calendar c) {
	...
	public static String getYearMonth(String dateStr) {
		return getDate(parseDate(dateStr), "yyyy-MM");
	}
	 ...
	 * @return
	 */
	public static String getYearMonth(String dateStr, int deff) {
		Calendar c = getCurCalendar();
...
/**
	...
	public static String getNextDateStr(String dateStr) {
		Calendar c = Calendar.getInstance();
		c.setTime(DateUtils.parseDate(dateStr));
		int day = c.get(Calendar.DATE);
		c.set(Calendar.DATE, day + 1);

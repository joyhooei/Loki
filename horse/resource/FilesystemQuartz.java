 ...
 * 
 */
@Controller("filesystemQuartz")
public class FilesystemQuartz {
	@Resource
	...
	public void mdoStatistics() {
		...
		String[] currdateA = { "2014-02-20" };
		for (String currdate : currdateA) {
			filesystemStatistics(currdate, 20);
		}
	...
	protected void filesystemStatistics(String currdate, Integer hour) {
		...
		System.out.println("filesystemQuartz:" + installList.size());
